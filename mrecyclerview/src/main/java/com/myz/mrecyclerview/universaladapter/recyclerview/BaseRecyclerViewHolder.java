...
public class BaseRecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseRecyclerViewHolder(Context context, View itemView, ViewGroup parent, int position) {
        super(itemView);
        mContext = context;
    ...
    public static BaseRecyclerViewHolder get(Context context, View convertView,
        ...
        if (convertView == null) {
            ...
            BaseRecyclerViewHolder holder = (BaseRecyclerViewHolder) convertView.getTag();
    ...
    public BaseRecyclerViewHolder setBigImageUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        ImageLoaderUtils.displayBigPhoto(mContext,view,url);
        return this;
    }
    public BaseRecyclerViewHolder setSmallImageUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        ImageLoaderUtils.displaySmallPhoto(mContext,view,url);
        return this;
    }
    public BaseRecyclerViewHolder setImageRoundUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        ImageLoaderUtils.displayRound(mContext,view,url);
        return this;
    }
    public BaseRecyclerViewHolder setImageFile(int viewId, File url) {
        ImageView view = getView(viewId);
        ImageLoaderUtils.display(mContext,view,url);
        return this;
    }

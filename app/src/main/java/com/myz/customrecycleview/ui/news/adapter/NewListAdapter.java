package com.myz.customrecycleview.ui.news.adapter;
...
import com.myz.customrecycleview.app.BaseApplication;
import com.myz.customrecycleview.bean.NewsPhotoDetail;
import com.myz.customrecycleview.bean.NewsSummary;
import com.myz.customrecycleview.utils.DisplayUtil;
...
public class NewListAdapter extends MultiItemRecycleViewAdapter<NewsSummary>
{
    ...
    @Override
    public void convert(BaseRecyclerViewHolder holder, NewsSummary newsSummary) {
     ...
     * @param position
     */
    private void setItemValues(final BaseRecyclerViewHolder holder, final NewsSummary newsSummary, final int position) {
     ...
     * @param position
     */
    private void setPhotoItemValues(BaseRecyclerViewHolder holder, final NewsSummary newsSummary, int position) {
    ...
    private void setImageView(BaseRecyclerViewHolder holder, NewsSummary newsSummary) {
    ...
    private void setPhotoImageView(BaseRecyclerViewHolder holder, String imgSrcLeft, String imgSrcMiddle, String imgSrcRight) {
        if (imgSrcLeft != null) {
